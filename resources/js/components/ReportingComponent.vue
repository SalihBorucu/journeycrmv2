                    ...
                    <div class="d-flex justify-content-around mb-2">
                        <div class="w-100 mx-2">
                            ...
                            <select class="form-control" v-model="account" @change="selectedAccount">
                                ...
                                <option :value="account" v-for="account in accounts">{{ account.name }}</option>
                            </select>
                        </div>
                        <div class="w-100 mx-2">
                            ...
                            <select class="form-control" v-model="campaign">
                                <option value="null"></option>
                                <option :value="campaign" v-for="campaign in campaigns">{{ campaign.name }}</option>
                            </select>
                        </div>
                        <div class="w-100 mx-2">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            selectedAccount() {
                this.campaigns = this.account.account_campaigns.map((accountCampaign) => accountCampaign.campaign);
            },
        },
    };
</script>
